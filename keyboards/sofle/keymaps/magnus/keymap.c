 ...
 * `-----------------------------------------+-------|    |-------+-----------------------------------------'
 *               | LGUI | LAlt | LCTR |      | SYM   |    | Enter |RAISE | RCTR | RAlt | RGUI |
 *               |      |      |      |      | Space |    | Space |      |      |      |      |
 *               `-----------------------------------'    `-----------------------------------'
 */
...
[_QWERTY] = LAYOUT(
		   ...
		   KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_NO,                   KC_NO,            KC_N,       KC_M,    KC_COMM, KC_DOT, KC_SLSH,  KC_RSFT,
		                     KC_LGUI, KC_LALT, KC_LCTL, KC_NO, LT(_SYM, KC_SPC),        LT(_SYM, KC_ENT), MO(_RAISE), KC_RCTL, KC_RALT, KC_RGUI
),
/* SYMBOLS
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |      |      |      |   (  |   [  |   {  |       |    |       |   }  |   ]  |   )  |   =  |   \  |      |
 * `-----------------------------------------+-------|    |-------+-----------------------------------------'
 *               | LGUI | LAlt | LCTR |      |   ▽  |    |   ▽  |RAISE | RCTR | RAlt | RGUI |
 *               `-----------------------------------'    `-----------------------------------'
 */
[_SYM] = LAYOUT(
  ...
  KC_NO,    KC_NO,   KC_NO,   KC_LPRN, KC_LBRC, KC_LCBR,  KC_NO,       KC_NO,    KC_RCBR, KC_RBRC, KC_RPRN, KC_EQL,  KC_BSLS, KC_NO,
                     KC_LGUI, KC_LALT, KC_LCTL, KC_NO,    KC_TRNS,     KC_TRNS,  KC_NO,   KC_RCTL, KC_RALT, KC_RGUI
),
/* RAISE
 * ,----------------------------------------.                     ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 * `-----------------------------------------+-------|    |-------+-----------------------------------------'
 *               | LGUI | LAlt | LCTR | SYM  | Space |    | Enter |RAISE | RCTR | RAlt | RGUI |
 *               `-----------------------------------'    `-----------------------------------'
 */
[_RAISE] = LAYOUT(
  KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,                         KC_NO,      KC_NO,    KC_NO,   KC_NO,    KC_NO,    KC_NO,
  KC_NO,    KC_INS,  KC_PSCR, KC_APP,  KC_NO,    KC_NO,                         KC_PGUP,    KC_PRVWD, KC_UP,   KC_NXTWD, KC_DLINE, KC_BSPC,
  ...
  KC_LSFT,  KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE, KC_NO,    KC_NO,       KC_NO,  KC_NO,      KC_LSTRT, KC_NO,   KC_LEND,  KC_NO,    KC_RSFT,
                     KC_LGUI, KC_LALT, KC_LCTL,  MO(_SYM), KC_SPC,      KC_ENT, MO(_RAISE), KC_RCTL, KC_RALT, KC_RGUI
),
};
