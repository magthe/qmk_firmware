 ...
 * `-----------------------------------------+-------|    |-------+-----------------------------------------'
 *               | LGUI | LAlt | LCTR |      |  SYM  |    |  SYM  |      | RCTR | RAlt | RGUI |
 *               |      |      |      |      | Space |    | Enter |      |      |      |      |
 *               `-----------------------------------'    `-----------------------------------'
 */
...
[_QWERTY] = LAYOUT(
		   ...
		   KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_NO,                   KC_NO,            KC_N,     KC_M,    KC_COMM, KC_DOT, KC_SLSH,  KC_RSFT,
		                     KC_LGUI, KC_LALT, KC_LCTL, KC_NO, LT(_SYM, KC_SPC),        LT(_SYM, KC_ENT), MO(_NAV), KC_RCTL, KC_RALT, KC_RGUI
),
/* SYMBOLS
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_NAV] = LAYOUT(
  ...
  KC_LSFT,  KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE, KC_NO,   KC_NO,       KC_NO,  KC_NO,   KC_LSTRT, KC_NO,   KC_LEND,  KC_NO,    KC_RSFT,
                     KC_LGUI, KC_LALT, KC_LCTL,  KC_NO,   KC_NO,       KC_NO,  KC_NO,   KC_RCTL, KC_RALT, KC_RGUI
),
};
